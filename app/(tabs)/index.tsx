                    ...
                    <View className="flex-1 mt-5">
                        ...
                        {trendingMovies && (
                            <View className="mt-10">
                                <Text className="text-lg text-white font-semibold mb-3">Trending Movies</Text>
                            </View>
                        )}
                        <>
                            <FlatList
                                ...
                                ItemSeparatorComponent={() => <Text className="w-8" />}
                                renderItem={({ item, index }) => {
                                    return <TrendingCard index={index} movie={item} />;
                                }}
                            />
